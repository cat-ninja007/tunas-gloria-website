    ...
    <section className="relative pt-36 pb-24 md:pt-44 md:pb-32">
      ...
      <div className="relative z-10 container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="max-w-3xl mx-auto text-center">
          <h1 className="text-4xl md:text-5xl font-bold text-white">Junior School</h1>
          <p className="mt-8 text-lg md:text-xl text-white/90 leading-relaxed">
            The Junior School curriculum is designed to prepare students for the academic challenges of high school while encouraging personal growth.
          </p>
        </div>
      </div>
    </section>
